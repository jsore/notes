...
class AlienInvasion:
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            ...
            # ship movement: flag on/off
                ...
                mouse_pos = pygame.mouse.get_pos()  # x/y cordinates tuple
    ...
    def _check_play_button(self, mouse_pos):
        ...
        # True/False flage for clearing Play button's clickable
        # area if it's not on screen
        button_clicked = self.play_button.rect.collidepoint(mouse_pos)

        # receives coordinates to check
        # if self.play_button.rect.collidepoint(mouse_pos):
        if button_clicked and not self.stats.game_active:
            # reset game stats first & trash the playboard
            ...
            # hide the cursor if game active
